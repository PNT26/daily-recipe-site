...
import { ArrowSmallRightIcon, HandThumbUpIcon } from '@heroicons/react/20/solid';
            ...
            <div className="w-[100%] relative">
                <div className="w-[100%] xs:w-[60%] md:w-[70%] lg:w-[75%] mx-auto px-[16px] md:px-0 relative z-[2]">
                    <div className="flex justify-start md:justify-between items-center mb-[16px] md:mb-[20px]">
                        ...
                        <button className="show-more-btn btn-transparent hidden lg:flex justify-center items-center">
                            Show more
                            <ArrowSmallRightIcon className="show-more-btn__icon w-[28px] ml-[12px]" />
                        </button>
                    </div>
                            ...
                            <div className="recipe-card md:max-w-[410px] md:min-w-[350px] rounded-[16px] cursor-pointer">
                                ...
                                <div className="p-[16px] bg-white rounded-b-[16px]">
                                    ...
                                    <div className="w-[100%] flex justify-between items-center mt-[8px] mb-[10px]">
                                        ...
                                        <a className="text-secondary-500 cursor-pointer hover:underline">Follow</a>
                                    </div>
                                    <div className="w-[100%] flex items-center justify-center gap-x-[8px]">
                                        <button className="btn-outline-primary--100 flex justify-center items-center gap-x-[4px]">
                                            {recipe.likes}
                                            <HandThumbUpIcon className="w-[20px] lg:w-[20px] ml-[4px]" />
                                        </button>
                                        <button className="btn-primary flex justify-between items-center gap-x-[12px] w-[100%]">
                                            Show Recipe
                                            <ArrowSmallRightIcon className="w-[22px] lg:w-[26px]" />
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <button className="lg:hidden btn-transparent flex justify-center items-center mt-[20px] mx-auto">
                        Show more
                        <ArrowSmallRightIcon className="w-[28px] ml-[12px]" />
                    </button>
                </div>
                <img src="https://asmpa.selise.cloud/1684302065_73f06b4500f0ec305190784c2f0e04_pasta_1.png" alt="pasta"
